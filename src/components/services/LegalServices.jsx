...
export default function LegalServices() {
  const services = [
    {
      title: "Legal Notice",
      desc: "Send professionally drafted legal notices with proper compliance.",
      icon: "📜",
    },
    {
      title: "Cheque Bounce Cases",
      desc: "End-to-end assistance in handling cheque bounce matters.",
      icon: "💳",
    },
    {
      title: "Agreement Drafting",
      desc: "Custom agreements tailored to your business or personal needs.",
      icon: "✍️",
    },
    {
      title: "Power of Attorney & Will",
      desc: "Secure your future with legally valid POA and will drafting.",
      icon: "🛡️",
    },
  ];

  const steps = ["Consultation", "Drafting", "Review", "Final Delivery"];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-[#5a5040] mt-4 max-w-xl mx-auto">
            Reliable legal documentation and advisory services to protect your rights and business.
          </p>
        </motion.div>
        ...
        <div className="text-center">
          ...
          <p className="text-[#5a5040] mt-4">
            Protect your business and rights with expert legal support.
          </p>
