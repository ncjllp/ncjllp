  ...
  const services = [
    {
      ...
      desc: "Register your NGO legally with trust, society, or section 8 company.",
      icon: "🤝",
    },
    {
      title: "80G & 12A Certification",
      desc: "Get tax exemptions and benefits for your organization.",
      icon: "📜",
    },
    {
      title: "FCRA Registration",
      desc: "Receive foreign funding legally with proper approval.",
      icon: "🌍",
    },
    {
      title: "CSR Compliance",
      desc: "Ensure compliance with corporate social responsibility laws.",
      icon: "🏢",
    },
  ];

  const steps = ["Consultation", "Documentation", "Registration", "Approval"];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-[#5a5040] mt-4 max-w-xl mx-auto">
            Start and manage your non-profit organization with full legal compliance and support.
          </p>
        </motion.div>
        ...
        <div className="text-center">
          ...
          <p className="text-[#5a5040] mt-4">
            Make a difference with a legally registered and compliant NGO.
          </p>
